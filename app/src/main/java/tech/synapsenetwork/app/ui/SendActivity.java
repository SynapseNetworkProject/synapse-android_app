...
import tech.synapsenetwork.app.ui.barcode.BarcodeCaptureActivity;
import tech.synapsenetwork.app.util.BalanceUtils;
import tech.synapsenetwork.app.util.QRURLParser;
import tech.synapsenetwork.app.viewmodel.SendViewModel;
...
public class SendActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        decimals = getIntent().getIntExtra(Constants.EXTRA_DECIMALS, Constants.ETHER_DECIMALS);
        symbol = getIntent().getStringExtra(Constants.EXTRA_SYMBOL);
        symbol = symbol == null ? Constants.ETH_SYMBOL : symbol;
        sendingTokens = getIntent().getBooleanExtra(Constants.EXTRA_SENDING_TOKENS, false);
        ...
        String toAddress = getIntent().getStringExtra(Constants.EXTRA_ADDRESS);
        if (toAddress != null) {
