...
import tech.synapsenetwork.app.ui.widget.holder.WalletHolder;
	...
	public BinderViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		...
		switch (viewType) {
			case WalletHolder.VIEW_TYPE: {
				WalletHolder h = new WalletHolder(tech.synapsenetwork.app.R.layout.item_wallet_manage, parent);
