...
import tech.synapsenetwork.app.ui.widget.adapter.TabPagerAdapter;
import tech.synapsenetwork.app.viewmodel.ImportWalletViewModel;
...
public class ImportWalletActivity extends BaseActivity {
    ...
    private void onWallet(Wallet wallet) {
        ...
        result.putExtra(Constants.Key.WALLET, wallet);
