 ...
 */
package tech.synapsenetwork.app.ui.barcode;
...
import tech.synapsenetwork.app.ui.camera.CameraSource;
import tech.synapsenetwork.app.ui.camera.CameraSourcePreview;
...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(tech.synapsenetwork.app.R.layout.layout_barcode_capture);

        mPreview = findViewById(tech.synapsenetwork.app.R.id.preview);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(this, tech.synapsenetwork.app.R.string.low_storage_error,
                        Toast.LENGTH_LONG).show();
                Log.w(TAG, getString(tech.synapsenetwork.app.R.string.low_storage_error));
            }
        }
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        builder.setTitle("Multitracker sample")
                .setMessage(tech.synapsenetwork.app.R.string.no_camera_permission)
                .setPositiveButton(tech.synapsenetwork.app.R.string.ok, listener)
                .show();
    }
