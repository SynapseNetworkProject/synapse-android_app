...
import tech.synapsenetwork.app.ui.widget.OnBackupClickListener;
...
public class BackupWarningView extends FrameLayout implements View.OnClickListener {
    ...
    public BackupWarningView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        init(tech.synapsenetwork.app.R.layout.layout_dialog_warning_backup);
    }

    private void init(@LayoutRes int layoutId) {
        setBackgroundColor(ContextCompat.getColor(getContext(), tech.synapsenetwork.app.R.color.white));
        LayoutInflater.from(getContext()).inflate(layoutId, this, true);
        findViewById(tech.synapsenetwork.app.R.id.backup_action).setOnClickListener(this);
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case tech.synapsenetwork.app.R.id.backup_action: {
