...
public class SystemView extends FrameLayout implements View.OnClickListener {
	...
	protected void onFinishInflate() {
		...
		View view = LayoutInflater.from(getContext()).inflate(tech.synapsenetwork.app.R.layout.layout_system_view, this, false);
		addView(view);
		progress = view.findViewById(tech.synapsenetwork.app.R.id.progress);

		errorBox = view.findViewById(tech.synapsenetwork.app.R.id.error_box);
		messageTxt = view.findViewById(tech.synapsenetwork.app.R.id.message);
		tryAgain = view.findViewById(tech.synapsenetwork.app.R.id.try_again);
		tryAgain.setOnClickListener(this);

		emptyBox = view.findViewById(tech.synapsenetwork.app.R.id.empty_box);
	}
	...
	public void showError(@Nullable String message, @Nullable OnClickListener onTryAgainClickListener) {
		if (recyclerView != null && recyclerView.getAdapter() != null && recyclerView.getAdapter().getItemCount() > 0) {
			hide();
			Snackbar.make(this,
					TextUtils.isEmpty(message) ? getContext().getString(tech.synapsenetwork.app.R.string.unknown_error) : message,
