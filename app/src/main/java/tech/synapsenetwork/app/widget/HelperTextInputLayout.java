...
public class HelperTextInputLayout extends TextInputLayout {
	...
	private int mHelperTextAppearance = tech.synapsenetwork.app.R.style.HelperTextAppearance;
	...
	public HelperTextInputLayout(Context _context, AttributeSet _attrs) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(
				_attrs,
				tech.synapsenetwork.app.R.styleable.HelperTextInputLayout,0,0);
		try {
			mHelperTextColor = a.getColorStateList(tech.synapsenetwork.app.R.styleable.HelperTextInputLayout_helperTextColor);
			mHelperText = a.getText(tech.synapsenetwork.app.R.styleable.HelperTextInputLayout_helperText);
		} finally {
			a.recycle();
		}
	}
